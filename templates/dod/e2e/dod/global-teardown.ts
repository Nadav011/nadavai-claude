...
export default async function globalTeardown() {
  ...
  console.log(
    `\n[dod] score=${t.score} overflow=${t.overflow_failures} axe=${t.axe_critical_serious} console=${t.console_errors} fonts=${t.font_families} touch=${t.touch_target_failures} reduced-motion=${t.reduced_motion_violations}`,
  );
